...
public class FlightSearchDTO {
    ...
    private List<FlightSearchListDTO> searchList;
    ...
    public FlightSearchDTO(String startPlace, String endPlace, Date startDate, CABIN_CLASS cabinClass, boolean rtn,
                           ...
                           Boolean muti, List<FlightSearchListDTO> searchList) {
    ...
    public FlightSearchDTO setMuti(Boolean muti) {
        this.muti = muti;
        return this;
    }

    public List<FlightSearchListDTO> getSearchList() {
        return searchList;
    }

    public FlightSearchDTO setSearchList(List<FlightSearchListDTO> searchList) {
        this.searchList = searchList;
        return this;
    }
